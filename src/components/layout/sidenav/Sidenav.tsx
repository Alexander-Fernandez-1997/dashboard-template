...
const sideLinks = [
  ...
  {
    direction: "/admin/productos",
    icon: <FaCoins />,
    text: "Productos",
  },
  {
    direction: "/admin/categorias",
    icon: <FaMoneyCheckAlt />,
    text: "Categorias",
  },
  {
    direction: "/admin/franquicias",
    icon: <FaStoreAlt />,
    text: "Franquicias",
  },
  {
    direction: "/admin/configuraciones",
    icon: <FaKey />,
    text: "Configuraciones",
  },
  {
    direction: "/admin/clientes",
    icon: <FaUser />,
    text: "Clientes",
  },
];
