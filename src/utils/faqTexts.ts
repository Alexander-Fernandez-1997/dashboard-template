...
const faqTexts: FaqText[] = [
  ...
  {
    id: 6,
    title: "¿Es posible recuperar un código QR en caso de haberlo perdido?",
    text: "Si extraviaste el código QR correspondiente a tu compra, podés contactarnos a través de tickifyatencionalcliente@gmail.com para recibir asistencia en su recuperación. Es importante que nos proporciones toda la información disponible sobre tu compra (nombre, apellido, correo electrónico del comprador y número de orden), de manera que podamos ayudarte a asegurar tu ingreso al evento.",
  },
  {
    id: 7,
    title: "¿Es posible solicitar la devolución de una entrada?",
    text: "Sí, en caso de arrepentirte de la compra, podés solicitar la devolución dentro de los primeros 10 días corridos desde la fecha de compra, siempre y cuando el evento aún no se haya llevado a cabo. El monto correspondiente a la devolución será acreditado en tu cuenta de Mercado Pago o aparecerá reflejado en el resumen de tu tarjeta de crédito. Tené en cuenta que solo se reembolsará el valor de la entrada, sin incluir el costo por el servicio, ya que el mismo ya fue realizado.",
  },
];
